...
static void initialize_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void initialize_params_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void enable_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void disable_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void set_sim_state_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance, const mxArray
   *c6_st);
static void finalize_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void sf_gateway_c6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void initSimStructsc6_Arti_DeltaSM_Control_Fricc
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *
...
static uint8_T c6_d_emlrt_marshallIn
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance, const mxArray
   *c6_b_is_active_c6_Arti_DeltaSM_Control_Fricc, const char_T *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance, const mxArray
   *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *
  chartInstance);
  ...
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_Arti_DeltaSM_Control_Fricc = 0U;
}
  ...
  (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_Arti_DeltaSM_Control_Fricc;
   ...
   *c6_st)
{
  ...
  *c6_y = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 0)),
    "y");
  chartInstance->c6_is_active_c6_Arti_DeltaSM_Control_Fricc =
    c6_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
    "is_active_c6_Arti_DeltaSM_Control_Fricc");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_Arti_DeltaSM_Control_Fricc(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance;
  chartInstance = (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c6_Arti_DeltaSM_Control_Fricc_get_eml_resolved_functions_info
  (void)
{
   ...
   *c6_b_is_active_c6_Arti_DeltaSM_Control_Fricc, const char_T *c6_identifier)
{
  ...
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_Arti_DeltaSM_Control_Fricc), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_Arti_DeltaSM_Control_Fricc);
  return c6_y;
}
...
void sf_c6_Arti_DeltaSM_Control_Fricc_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_Arti_DeltaSM_Control_Fricc_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_Arti_DeltaSM_Control_Fricc_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_Arti_DeltaSM_Control_Fricc_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_Arti_DeltaSM_Control_Fricc(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c6_Arti_DeltaSM_Control_Fricc\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_Arti_DeltaSM_Control_Fricc_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
  initialize_c6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  enable_c6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  disable_c6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  sf_gateway_c6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_Arti_DeltaSM_Control_Fricc
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_Arti_DeltaSM_Control_Fricc();/* state var info */
...
extern void sf_internal_set_sim_state_c6_Arti_DeltaSM_Control_Fricc(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_Arti_DeltaSM_Control_Fricc();/* state var info */
  ...
  set_sim_state_c6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_Arti_DeltaSM_Control_Fricc
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c6_Arti_DeltaSM_Control_Fricc(S);
}

static void sf_opaque_set_sim_state_c6_Arti_DeltaSM_Control_Fricc(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c6_Arti_DeltaSM_Control_Fricc(S, st);
}

static void sf_opaque_terminate_c6_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_Arti_DeltaSM_Control_Fricc
      ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_Arti_DeltaSM_Control_Fricc
    ((SFc6_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_Arti_DeltaSM_Control_FriccInstanceStruct *)utMalloc
    (sizeof(SFc6_Arti_DeltaSM_Control_FriccInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_Arti_DeltaSM_Control_FriccInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_Arti_DeltaSM_Control_Fricc;
...
void c6_Arti_DeltaSM_Control_Fricc_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_Arti_DeltaSM_Control_Fricc(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_Arti_DeltaSM_Control_Fricc(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_Arti_DeltaSM_Control_Fricc(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_Arti_DeltaSM_Control_Fricc_method_dispatcher.\n"
