...
#include <stddef.h>
#include "blas.h"
#include "Opera_Delt_Angulos_sfun.h"
#include "c1_Opera_Delt_Angulos.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Opera_Delt_Angulos_sfun_debug_macros.h"
...
static const char * c1_debug_family_names[25] = { "theta", "thetaA", "thetaB",
  "alpha", "R", "r", "L1", "L2", "R1", "Si", "i", "Qi", "S1", "C1", "nargin",
  "nargout", "Px", "Py", "Pz", "AntThetaM1", "AntThetaM2", "AntThetaM3",
  "ThetaM1", "ThetaM2", "ThetaM3" };

/* Function Declarations */
static void initialize_c1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static void initialize_params_c1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static void enable_c1_Opera_Delt_Angulos(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance);
static void disable_c1_Opera_Delt_Angulos(SFc1_Opera_Delt_AngulosInstanceStruct *
  chartInstance);
static void c1_update_debugger_state_c1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static void set_sim_state_c1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_Opera_Delt_Angulos(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance);
static void sf_gateway_c1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static void c1_chartstep_c1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static void initSimStructsc1_Opera_Delt_Angulos
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance, const mxArray *c1_ThetaM3, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[3]);
...
static real_T c1_mpower(SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance,
  real_T c1_a);
static void c1_eml_scalar_eg(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance);
static void c1_eml_error(SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance);
static real_T c1_atan2(SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance,
  real_T c1_y, real_T c1_x);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_Opera_Delt_Angulos, const
  char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Opera_Delt_AngulosInstanceStruct
  *chartInstance);
  ...
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Opera_Delt_Angulos = 0U;
}
  ...
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance)
{
  ...
  c1_d_hoistedGlobal = chartInstance->c1_is_active_c1_Opera_Delt_Angulos;
  ...
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_ThetaM3 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 2)), "ThetaM3");
  chartInstance->c1_is_active_c1_Opera_Delt_Angulos = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
     "is_active_c1_Opera_Delt_Angulos");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Opera_Delt_Angulos(chartInstance);
  ...
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance)
{
  ...
  real_T *c1_ThetaM2;
  real_T *c1_ThetaM3;
  real_T *c1_AntThetaM1;
  real_T *c1_AntThetaM2;
  real_T *c1_AntThetaM3;
  c1_AntThetaM3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c1_AntThetaM2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c1_AntThetaM1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c1_ThetaM3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c1_ThetaM2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_ThetaM1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Opera_Delt_Angulos(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Opera_Delt_AngulosMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c1_ThetaM1, 3U);
  _SFD_DATA_RANGE_CHECK(*c1_ThetaM2, 4U);
  _SFD_DATA_RANGE_CHECK(*c1_ThetaM3, 5U);
  _SFD_DATA_RANGE_CHECK(*c1_AntThetaM1, 6U);
  _SFD_DATA_RANGE_CHECK(*c1_AntThetaM2, 7U);
  _SFD_DATA_RANGE_CHECK(*c1_AntThetaM3, 8U);
}
  ...
  (SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance)
{
  ...
  real_T *c1_b_ThetaM2;
  real_T *c1_b_ThetaM1;
  real_T *c1_b_AntThetaM3;
  real_T *c1_b_AntThetaM2;
  real_T *c1_b_AntThetaM1;
  real_T *c1_b_Pz;
  real_T *c1_b_Py;
  real_T *c1_b_Px;
  c1_b_AntThetaM3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c1_b_AntThetaM2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c1_b_AntThetaM1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  c1_d_hoistedGlobal = *c1_b_AntThetaM1;
  c1_e_hoistedGlobal = *c1_b_AntThetaM2;
  c1_f_hoistedGlobal = *c1_b_AntThetaM3;
  c1_Px = c1_hoistedGlobal;
  c1_Py = c1_b_hoistedGlobal;
  c1_Pz = c1_c_hoistedGlobal;
  c1_AntThetaM1 = c1_d_hoistedGlobal;
  c1_AntThetaM2 = c1_e_hoistedGlobal;
  c1_AntThetaM3 = c1_f_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 25U, 25U, c1_debug_family_names,
    c1_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_theta, 0U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_thetaA, 1U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_thetaB, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_alpha, 3U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_R, 4U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_r, 5U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_L1, 6U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_L2, 7U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_R1, 8U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_Si, 9U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_i, 10U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_Qi, 11U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_S1, 12U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_C1, 13U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 15U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_Px, 16U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_Py, 17U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_Pz, 18U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_AntThetaM1, 19U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_AntThetaM2, 20U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_AntThetaM3, 21U, c1_sf_marshallOut);
  ...
  for (c1_i3 = 0; c1_i3 < 3; c1_i3++) {
    c1_alpha[c1_i3] = 1.5707963267948966 + 2.0943951023931953 * (real_T)c1_i3;
  }
  ...
  c1_Si = 0.0076923076923076927 * (((((-c1_mpower(chartInstance, c1_Px) -
    c1_mpower(chartInstance, c1_Py)) - c1_mpower(chartInstance, c1_Pz)) +
    c1_mpower(chartInstance, 275.0)) - c1_mpower(chartInstance, 130.0)) -
    c1_mpower(chartInstance, 30.78));
  ...
  while (c1_b_i < 3) {
    ...
    c1_x = c1_alpha[_SFD_EML_ARRAY_BOUNDS_CHECK("alpha", (int32_T)
      _SFD_INTEGER_CHECK("i", c1_i), 1, 3, 1, 0) - 1];
    c1_b_x = c1_x;
    c1_b_x = muDoubleScalarCos(c1_b_x);
    c1_c_x = c1_alpha[_SFD_EML_ARRAY_BOUNDS_CHECK("alpha", (int32_T)
      _SFD_INTEGER_CHECK("i", c1_i), 1, 3, 1, 0) - 1];
    c1_d_x = c1_c_x;
    c1_d_x = muDoubleScalarSin(c1_d_x);
    c1_Qi = 2.0 * c1_Px * c1_b_x + 2.0 * c1_Py * c1_d_x;
    ...
    c1_g_x = c1_f_x;
    c1_y = c1_g_x / 130.0;
    c1_h_x = (((4.0 * c1_mpower(chartInstance, c1_Pz) + 3789.6336) - c1_mpower
               (chartInstance, c1_Si)) + c1_mpower(chartInstance, c1_Qi) *
              0.94394033136094679) + c1_Qi * (c1_y - 123.12);
    c1_i_x = c1_h_x;
    if (c1_i_x < 0.0) {
    ...
    c1_S1 = -2.0 * c1_Pz - c1_i_x;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 150U);
    c1_C1 = (-61.56 - c1_Qi * -0.76323076923076916) - c1_Si;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 153U);
    c1_theta[_SFD_EML_ARRAY_BOUNDS_CHECK("theta", (int32_T)_SFD_INTEGER_CHECK(
      "i", c1_i), 1, 3, 1, 0) - 1] = c1_atan2(chartInstance, c1_S1, c1_C1) * 2.0;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 154U);
    c1_thetaA[_SFD_EML_ARRAY_BOUNDS_CHECK("thetaA", (int32_T)_SFD_INTEGER_CHECK(
      "i", c1_i), 1, 3, 1, 0) - 1] = c1_atan2(chartInstance, c1_S1, c1_C1) * 2.0;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 155U);
    c1_thetaB[_SFD_EML_ARRAY_BOUNDS_CHECK("thetaB", (int32_T)_SFD_INTEGER_CHECK(
      "i", c1_i), 1, 3, 1, 0) - 1] = -c1_atan2(chartInstance, c1_S1, -c1_C1) *
      2.0;
    c1_b_i++;
  ...
  c1_j_x = c1_thetaA[0] - c1_AntThetaM1;
  c1_k_x = c1_j_x;
  c1_b_y = muDoubleScalarAbs(c1_k_x);
  c1_l_x = c1_thetaB[0] - c1_AntThetaM1;
  c1_m_x = c1_l_x;
  c1_c_y = muDoubleScalarAbs(c1_m_x);
  if (CV_EML_IF(0, 1, 0, c1_b_y < c1_c_y)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 188U);
    c1_ThetaM1 = c1_thetaA[0];
  } else {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 190U);
    c1_ThetaM1 = c1_thetaB[0];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 194U);
  c1_n_x = c1_thetaA[1] - c1_AntThetaM2;
  c1_o_x = c1_n_x;
  c1_d_y = muDoubleScalarAbs(c1_o_x);
  c1_p_x = c1_thetaB[1] - c1_AntThetaM2;
  c1_q_x = c1_p_x;
  c1_e_y = muDoubleScalarAbs(c1_q_x);
  if (CV_EML_IF(0, 1, 1, c1_d_y < c1_e_y)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 195U);
    c1_ThetaM2 = c1_thetaA[1];
  } else {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 197U);
    c1_ThetaM2 = c1_thetaB[1];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 200U);
  c1_r_x = c1_thetaA[2] - c1_AntThetaM3;
  c1_s_x = c1_r_x;
  c1_f_y = muDoubleScalarAbs(c1_s_x);
  c1_t_x = c1_thetaB[2] - c1_AntThetaM3;
  c1_u_x = c1_t_x;
  c1_g_y = muDoubleScalarAbs(c1_u_x);
  if (CV_EML_IF(0, 1, 2, c1_f_y < c1_g_y)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 201U);
    c1_ThetaM3 = c1_thetaA[2];
  } else {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 203U);
    c1_ThetaM3 = c1_thetaB[2];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -203);
  _SFD_SYMBOL_SCOPE_POP();
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance;
  chartInstance = (SFc1_Opera_Delt_AngulosInstanceStruct *)chartInstanceVoid;
  ...
  *c1_inData)
{
  ...
  for (c1_i4 = 0; c1_i4 < 3; c1_i4++) {
    c1_b_inData[c1_i4] = (*(real_T (*)[3])c1_inData)[c1_i4];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance;
  chartInstance = (SFc1_Opera_Delt_AngulosInstanceStruct *)chartInstanceVoid;
  c1_alpha = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_alpha), &c1_thisId, c1_y);
  sf_mex_destroy(&c1_alpha);
  for (c1_i7 = 0; c1_i7 < 3; c1_i7++) {
    (*(real_T (*)[3])c1_outData)[c1_i7] = c1_y[c1_i7];
  }

  sf_mex_destroy(&c1_mxArrayInData);
}

const mxArray *sf_c1_Opera_Delt_Angulos_get_eml_resolved_functions_info(void)
{
  const mxArray *c1_nameCaptureInfo = NULL;
  c1_nameCaptureInfo = NULL;
  sf_mex_assign(&c1_nameCaptureInfo, sf_mex_createstruct("structure", 2, 34, 1),
                false);
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, sf_mex_duplicatearraysafe(&c1_lhs23), "lhs", "lhs",
                  23);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(""), "context", "context", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("sqrt"), "name", "name", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Opera_Delt_Angulos), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Opera_Delt_Angulos);
  return c1_y;
}
...
void sf_c1_Opera_Delt_Angulos_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4031599368U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3786894960U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3555761460U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3495187931U);
}

mxArray *sf_c1_Opera_Delt_Angulos_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("003BIvH1K6kmlG2duNyx3");
...
mxArray *sf_c1_Opera_Delt_Angulos_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Opera_Delt_Angulos_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Opera_Delt_Angulos(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"ThetaM1\",},{M[1],M[9],T\"ThetaM2\",},{M[1],M[10],T\"ThetaM3\",},{M[8],M[0],T\"is_active_c1_Opera_Delt_Angulos\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Opera_Delt_Angulos_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_Opera_Delt_AngulosInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _Opera_Delt_AngulosMachineNumber_,
           1,
           1,
           1,
           0,
        ...
        init_script_number_translation(_Opera_Delt_AngulosMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Opera_Delt_AngulosMachineNumber_,
          ...
          _SFD_SET_DATA_PROPS(6,1,1,0,"AntThetaM1");
          _SFD_SET_DATA_PROPS(7,1,1,0,"AntThetaM2");
          _SFD_SET_DATA_PROPS(8,1,1,0,"AntThetaM3");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,4875);
        _SFD_CV_INIT_EML_IF(0,1,0,4437,4496,4522,4557);
        _SFD_CV_INIT_EML_IF(0,1,1,4560,4619,4645,4680);
        _SFD_CV_INIT_EML_IF(0,1,2,4682,4741,4767,4802);
        _SFD_CV_INIT_EML_FOR(0,1,0,3691,3701,4435);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(6U, c1_AntThetaM1);
          _SFD_SET_DATA_VALUE_PTR(7U, c1_AntThetaM2);
          _SFD_SET_DATA_VALUE_PTR(8U, c1_AntThetaM3);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Opera_Delt_AngulosMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "fhJHucQKlZgqglAp9VdqPG";
}

static void sf_opaque_initialize_c1_Opera_Delt_Angulos(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInstanceVar);
  initialize_c1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_Opera_Delt_Angulos(void *chartInstanceVar)
{
  enable_c1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_Opera_Delt_Angulos(void *chartInstanceVar)
{
  disable_c1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_Opera_Delt_Angulos(void *chartInstanceVar)
{
  sf_gateway_c1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Opera_Delt_Angulos(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Opera_Delt_Angulos
    ((SFc1_Opera_Delt_AngulosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Opera_Delt_Angulos();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Opera_Delt_Angulos(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Opera_Delt_Angulos();/* state var info */
  ...
  set_sim_state_c1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Opera_Delt_Angulos(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Opera_Delt_Angulos(S);
}

static void sf_opaque_set_sim_state_c1_Opera_Delt_Angulos(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_Opera_Delt_Angulos(S, st);
}

static void sf_opaque_terminate_c1_Opera_Delt_Angulos(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Opera_Delt_AngulosInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Opera_Delt_Angulos_optimization_info();
    }

    finalize_c1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_Opera_Delt_Angulos((SFc1_Opera_Delt_AngulosInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Opera_Delt_Angulos(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_Opera_Delt_Angulos
      ((SFc1_Opera_Delt_AngulosInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_Opera_Delt_Angulos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Opera_Delt_Angulos_optimization_info();
  ...
  ssSetChecksum0(S,(91751270U));
  ssSetChecksum1(S,(2966991833U));
  ssSetChecksum2(S,(72365167U));
  ssSetChecksum3(S,(1806860425U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_Opera_Delt_Angulos(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Opera_Delt_Angulos(SimStruct *S)
{
  SFc1_Opera_Delt_AngulosInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Opera_Delt_AngulosInstanceStruct *)utMalloc(sizeof
    (SFc1_Opera_Delt_AngulosInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Opera_Delt_AngulosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Opera_Delt_Angulos;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Opera_Delt_Angulos;
...
void c1_Opera_Delt_Angulos_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Opera_Delt_Angulos(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Opera_Delt_Angulos(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Opera_Delt_Angulos(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Opera_Delt_Angulos_method_dispatcher.\n"
