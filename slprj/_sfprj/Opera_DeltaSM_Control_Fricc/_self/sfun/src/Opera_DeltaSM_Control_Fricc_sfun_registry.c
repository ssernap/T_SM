...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Opera_DeltaSM_Control_Fricc_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Opera_DeltaSM_Control_Fricc_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Opera_DeltaSM_Control_Fricc_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Opera_DeltaSM_Control_Fricc") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Opera_DeltaSM_Control_Fricc_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_Opera_DeltaSM_Control_Fricc_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Opera_DeltaSM_Control_Fricc") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Opera_DeltaSM_Control_Fricc_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Opera_DeltaSM_Control_Fricc_updateBuildInfo_args_info
  ...
  if (strcmp(machineName, "Opera_DeltaSM_Control_Fricc") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Opera_DeltaSM_Control_Fricc_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_Opera_DeltaSM_Control_Fricc_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "Opera_DeltaSM_Control_Fricc") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Opera_DeltaSM_Control_Fricc_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_Opera_DeltaSM_Control_Fricc_method_dispatcher(SimStruct
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Opera_DeltaSM_Control_Fricc")) {
    return(sf_Opera_DeltaSM_Control_Fricc_method_dispatcher(simstructPtr,
...
extern void Opera_DeltaSM_Control_Fricc_initializer(void);
extern void Opera_DeltaSM_Control_Fricc_register_exported_symbols(SimStruct* S);
extern void Opera_DeltaSM_Control_Fricc_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Opera_DeltaSM_Control_Fricc_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Opera_DeltaSM_Control_Fricc_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    Opera_DeltaSM_Control_Fricc_initializer();
  }
