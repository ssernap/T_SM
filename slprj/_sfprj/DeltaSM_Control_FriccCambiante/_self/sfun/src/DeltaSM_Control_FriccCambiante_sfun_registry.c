...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_DeltaSM_Control_FriccCambiante_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_DeltaSM_Control_FriccCambiante_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_DeltaSM_Control_FriccCambiante_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "DeltaSM_Control_FriccCambiante") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DeltaSM_Control_FriccCambiante_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_DeltaSM_Control_FriccCambiante_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "DeltaSM_Control_FriccCambiante") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DeltaSM_Control_FriccCambiante_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_DeltaSM_Control_FriccCambiante_updateBuildInfo_args_info( int nlhs,
  ...
  if (strcmp(machineName, "DeltaSM_Control_FriccCambiante") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DeltaSM_Control_FriccCambiante_updateBuildInfo_args_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_DeltaSM_Control_FriccCambiante_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "DeltaSM_Control_FriccCambiante") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_DeltaSM_Control_FriccCambiante_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_DeltaSM_Control_FriccCambiante_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"DeltaSM_Control_FriccCambiante")) {
    return(sf_DeltaSM_Control_FriccCambiante_method_dispatcher(simstructPtr,
...
extern void DeltaSM_Control_FriccCambiante_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    DeltaSM_Control_FriccCambiante_terminator();
...
extern void DeltaSM_Control_FriccCambiante_initializer(void);
extern void DeltaSM_Control_FriccCambiante_register_exported_symbols(SimStruct*
  S);
extern void DeltaSM_Control_FriccCambiante_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  DeltaSM_Control_FriccCambiante_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      DeltaSM_Control_FriccCambiante_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    DeltaSM_Control_FriccCambiante_initializer();
  }
