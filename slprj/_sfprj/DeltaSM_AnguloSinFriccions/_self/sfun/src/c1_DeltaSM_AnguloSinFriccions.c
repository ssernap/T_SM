...
#include <stddef.h>
#include "blas.h"
#include "DeltaSM_AnguloSinFriccions_sfun.h"
#include "c1_DeltaSM_AnguloSinFriccions.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "DeltaSM_AnguloSinFriccions_sfun_debug_macros.h"
...
static void initialize_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void initialize_params_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void enable_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void disable_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void set_sim_state_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void sf_gateway_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void c1_chartstep_c1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void initSimStructsc1_DeltaSM_AnguloSinFriccions
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *
...
static real_T c1_mpower(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct
  *chartInstance, real_T c1_a);
static void c1_eml_scalar_eg(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct
  *chartInstance);
static void c1_eml_error(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct
  *chartInstance);
static real_T c1_atan2(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct
...
static uint8_T c1_e_emlrt_marshallIn
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance, const mxArray
   *c1_b_is_active_c1_DeltaSM_AnguloSinFriccions, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance, const mxArray
   *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *
  chartInstance);
  ...
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DeltaSM_AnguloSinFriccions = 0U;
}
  ...
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance)
{
  ...
  c1_d_hoistedGlobal = chartInstance->c1_is_active_c1_DeltaSM_AnguloSinFriccions;
   ...
   *c1_st)
{
  ...
  *c1_ThetaM3 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 2)), "ThetaM3");
  chartInstance->c1_is_active_c1_DeltaSM_AnguloSinFriccions =
    c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
    "is_active_c1_DeltaSM_AnguloSinFriccions");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DeltaSM_AnguloSinFriccions(chartInstance);
  ...
  (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_DeltaSM_AnguloSinFriccions(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_DeltaSM_AnguloSinFriccionsMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance;
  chartInstance = (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c1_DeltaSM_AnguloSinFriccions_get_eml_resolved_functions_info
  (void)
{
   ...
   *c1_b_is_active_c1_DeltaSM_AnguloSinFriccions, const char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_DeltaSM_AnguloSinFriccions), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_DeltaSM_AnguloSinFriccions);
  return c1_y;
}
...
void sf_c1_DeltaSM_AnguloSinFriccions_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_DeltaSM_AnguloSinFriccions_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_DeltaSM_AnguloSinFriccions_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_DeltaSM_AnguloSinFriccions_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_DeltaSM_AnguloSinFriccions(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"ThetaM1\",},{M[1],M[9],T\"ThetaM2\",},{M[1],M[10],T\"ThetaM3\",},{M[8],M[0],T\"is_active_c1_DeltaSM_AnguloSinFriccions\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DeltaSM_AnguloSinFriccions_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _DeltaSM_AnguloSinFriccionsMachineNumber_,
           1,
           1,
           1,
           0,
        ...
        init_script_number_translation(_DeltaSM_AnguloSinFriccionsMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _DeltaSM_AnguloSinFriccionsMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_DeltaSM_AnguloSinFriccions(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*) chartInstanceVar);
  initialize_c1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DeltaSM_AnguloSinFriccions(void
  *chartInstanceVar)
{
  enable_c1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_DeltaSM_AnguloSinFriccions(void
  *chartInstanceVar)
{
  disable_c1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_DeltaSM_AnguloSinFriccions(void
  *chartInstanceVar)
{
  sf_gateway_c1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_DeltaSM_AnguloSinFriccions
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DeltaSM_AnguloSinFriccions();/* state var info */
...
extern void sf_internal_set_sim_state_c1_DeltaSM_AnguloSinFriccions(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_DeltaSM_AnguloSinFriccions();/* state var info */
  ...
  set_sim_state_c1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_DeltaSM_AnguloSinFriccions
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DeltaSM_AnguloSinFriccions(S);
}

static void sf_opaque_set_sim_state_c1_DeltaSM_AnguloSinFriccions(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_DeltaSM_AnguloSinFriccions(S, st);
}

static void sf_opaque_terminate_c1_DeltaSM_AnguloSinFriccions(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_DeltaSM_AnguloSinFriccions_optimization_info();
    }

    finalize_c1_DeltaSM_AnguloSinFriccions
      ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_DeltaSM_AnguloSinFriccions
    ((SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DeltaSM_AnguloSinFriccions(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_DeltaSM_AnguloSinFriccions(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_DeltaSM_AnguloSinFriccions_optimization_info();
...
static void mdlRTW_c1_DeltaSM_AnguloSinFriccions(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_DeltaSM_AnguloSinFriccions(SimStruct *S)
{
  SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct *)utMalloc
    (sizeof(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DeltaSM_AnguloSinFriccionsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DeltaSM_AnguloSinFriccions;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_DeltaSM_AnguloSinFriccions;
...
void c1_DeltaSM_AnguloSinFriccions_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DeltaSM_AnguloSinFriccions(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DeltaSM_AnguloSinFriccions(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DeltaSM_AnguloSinFriccions(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DeltaSM_AnguloSinFriccions_method_dispatcher.\n"
