...
static void initialize_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void initialize_params_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void enable_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void disable_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void set_sim_state_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void sf_gateway_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void c1_chartstep_c1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void initSimStructsc1_Arti_DeltaSM_Control_Fricc
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *
...
static real_T c1_mpower(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct
  *chartInstance, real_T c1_a);
static void c1_eml_scalar_eg(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct
  *chartInstance);
static void c1_eml_error(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct
  *chartInstance);
static real_T c1_atan2(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct
...
static uint8_T c1_e_emlrt_marshallIn
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance, const mxArray
   *c1_b_is_active_c1_Arti_DeltaSM_Control_Fricc, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance, const mxArray
   *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *
  chartInstance);
  ...
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Arti_DeltaSM_Control_Fricc = 0U;
}
  ...
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance)
{
  ...
  c1_d_hoistedGlobal = chartInstance->c1_is_active_c1_Arti_DeltaSM_Control_Fricc;
   ...
   *c1_st)
{
  ...
  *c1_ThetaM3 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 2)), "ThetaM3");
  chartInstance->c1_is_active_c1_Arti_DeltaSM_Control_Fricc =
    c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
    "is_active_c1_Arti_DeltaSM_Control_Fricc");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Arti_DeltaSM_Control_Fricc(chartInstance);
  ...
  (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Arti_DeltaSM_Control_Fricc(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance;
  chartInstance = (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c1_Arti_DeltaSM_Control_Fricc_get_eml_resolved_functions_info
  (void)
{
   ...
   *c1_b_is_active_c1_Arti_DeltaSM_Control_Fricc, const char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Arti_DeltaSM_Control_Fricc), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Arti_DeltaSM_Control_Fricc);
  return c1_y;
}
...
void sf_c1_Arti_DeltaSM_Control_Fricc_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Arti_DeltaSM_Control_Fricc_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Arti_DeltaSM_Control_Fricc_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Arti_DeltaSM_Control_Fricc_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Arti_DeltaSM_Control_Fricc(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"ThetaM1\",},{M[1],M[9],T\"ThetaM2\",},{M[1],M[10],T\"ThetaM3\",},{M[8],M[0],T\"is_active_c1_Arti_DeltaSM_Control_Fricc\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Arti_DeltaSM_Control_Fricc_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
  initialize_c1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  enable_c1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  disable_c1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  sf_gateway_c1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Arti_DeltaSM_Control_Fricc
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Arti_DeltaSM_Control_Fricc();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Arti_DeltaSM_Control_Fricc(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Arti_DeltaSM_Control_Fricc();/* state var info */
  ...
  set_sim_state_c1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Arti_DeltaSM_Control_Fricc
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Arti_DeltaSM_Control_Fricc(S);
}

static void sf_opaque_set_sim_state_c1_Arti_DeltaSM_Control_Fricc(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_Arti_DeltaSM_Control_Fricc(S, st);
}

static void sf_opaque_terminate_c1_Arti_DeltaSM_Control_Fricc(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_Arti_DeltaSM_Control_Fricc
      ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Arti_DeltaSM_Control_Fricc
    ((SFc1_Arti_DeltaSM_Control_FriccInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Arti_DeltaSM_Control_Fricc(SimStruct *S)
{
  SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Arti_DeltaSM_Control_FriccInstanceStruct *)utMalloc
    (sizeof(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Arti_DeltaSM_Control_FriccInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Arti_DeltaSM_Control_Fricc;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Arti_DeltaSM_Control_Fricc;
...
void c1_Arti_DeltaSM_Control_Fricc_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Arti_DeltaSM_Control_Fricc(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Arti_DeltaSM_Control_Fricc(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Arti_DeltaSM_Control_Fricc(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Arti_DeltaSM_Control_Fricc_method_dispatcher.\n"
