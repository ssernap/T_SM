...
#include <stddef.h>
#include "blas.h"
#include "Arti_DeltaSM_AngulosSinFricc_sfun.h"
#include "c1_Arti_DeltaSM_AngulosSinFricc.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Arti_DeltaSM_AngulosSinFricc_sfun_debug_macros.h"
...
static void initialize_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void initialize_params_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void enable_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void disable_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void set_sim_state_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void sf_gateway_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void c1_chartstep_c1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
static void initSimStructsc1_Arti_DeltaSM_AngulosSinFricc
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance);
...
static real_T c1_emlrt_marshallIn
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance, const mxArray
   *c1_ThPPM3, const char_T *c1_identifier);
...
static real_T c1_polyval(SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct
  *chartInstance, real_T c1_p[6], real_T c1_x);
static void c1_polyder(SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct
  *chartInstance, real_T c1_u[6], real_T c1_a_data[], int32_T c1_a_sizes[2]);
static boolean_T c1_isfinite(SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct
  *chartInstance, real_T c1_x);
static real_T c1_b_polyval(SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct
  *chartInstance, real_T c1_p_data[], int32_T c1_p_sizes[2], real_T c1_x);
static void c1_b_polyder(SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct
  *chartInstance, real_T c1_u_data[], int32_T c1_u_sizes[2], real_T c1_a_data[],
  int32_T c1_a_sizes[2]);
static void c1_trim_leading_zeros
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance, real_T
   c1_x_data[], int32_T c1_x_sizes[2], real_T c1_y_data[], int32_T c1_y_sizes[2]);
...
static uint8_T c1_d_emlrt_marshallIn
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance, const mxArray
   *c1_b_is_active_c1_Arti_DeltaSM_AngulosSinFricc, const char_T *c1_identifier);
  ...
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Arti_DeltaSM_AngulosSinFricc = 0U;
}
  ...
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance)
{
  ...
  c1_j_hoistedGlobal =
    chartInstance->c1_is_active_c1_Arti_DeltaSM_AngulosSinFricc;
   ...
   *c1_st)
{
  ...
  *c1_ThetaM3 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 8)), "ThetaM3");
  chartInstance->c1_is_active_c1_Arti_DeltaSM_AngulosSinFricc =
    c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 9)),
    "is_active_c1_Arti_DeltaSM_AngulosSinFricc");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Arti_DeltaSM_AngulosSinFricc(chartInstance);
  ...
  (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Arti_DeltaSM_AngulosSinFricc(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Arti_DeltaSM_AngulosSinFriccMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance;
  chartInstance = (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *)
    chartInstanceVoid;
   ...
   *c1_b_is_active_c1_Arti_DeltaSM_AngulosSinFricc, const char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Arti_DeltaSM_AngulosSinFricc), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Arti_DeltaSM_AngulosSinFricc);
  return c1_y;
}
...
void sf_c1_Arti_DeltaSM_AngulosSinFricc_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Arti_DeltaSM_AngulosSinFricc_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Arti_DeltaSM_AngulosSinFricc_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Arti_DeltaSM_AngulosSinFricc_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Arti_DeltaSM_AngulosSinFricc(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[29],T\"ThPM1\",},{M[1],M[30],T\"ThPM2\",},{M[1],M[31],T\"ThPM3\",},{M[1],M[32],T\"ThPPM1\",},{M[1],M[33],T\"ThPPM2\",},{M[1],M[34],T\"ThPPM3\",},{M[1],M[8],T\"ThetaM1\",},{M[1],M[9],T\"ThetaM2\",},{M[1],M[10],T\"ThetaM3\",},{M[8],M[0],T\"is_active_c1_Arti_DeltaSM_AngulosSinFricc\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Arti_DeltaSM_AngulosSinFricc_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Arti_DeltaSM_AngulosSinFriccMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_Arti_DeltaSM_AngulosSinFricc(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*) chartInstanceVar);
  initialize_c1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Arti_DeltaSM_AngulosSinFricc(void
  *chartInstanceVar)
{
  enable_c1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Arti_DeltaSM_AngulosSinFricc(void
  *chartInstanceVar)
{
  disable_c1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Arti_DeltaSM_AngulosSinFricc(void
  *chartInstanceVar)
{
  sf_gateway_c1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Arti_DeltaSM_AngulosSinFricc
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Arti_DeltaSM_AngulosSinFricc();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Arti_DeltaSM_AngulosSinFricc(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Arti_DeltaSM_AngulosSinFricc();/* state var info */
  ...
  set_sim_state_c1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Arti_DeltaSM_AngulosSinFricc
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Arti_DeltaSM_AngulosSinFricc(S);
}

static void sf_opaque_set_sim_state_c1_Arti_DeltaSM_AngulosSinFricc(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_Arti_DeltaSM_AngulosSinFricc(S, st);
}

static void sf_opaque_terminate_c1_Arti_DeltaSM_AngulosSinFricc(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Arti_DeltaSM_AngulosSinFricc_optimization_info();
    }

    finalize_c1_Arti_DeltaSM_AngulosSinFricc
      ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Arti_DeltaSM_AngulosSinFricc
    ((SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Arti_DeltaSM_AngulosSinFricc(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Arti_DeltaSM_AngulosSinFricc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Arti_DeltaSM_AngulosSinFricc_optimization_info();
...
static void mdlRTW_c1_Arti_DeltaSM_AngulosSinFricc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Arti_DeltaSM_AngulosSinFricc(SimStruct *S)
{
  SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct *)utMalloc
    (sizeof(SFc1_Arti_DeltaSM_AngulosSinFriccInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Arti_DeltaSM_AngulosSinFricc;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Arti_DeltaSM_AngulosSinFricc;
...
void c1_Arti_DeltaSM_AngulosSinFricc_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Arti_DeltaSM_AngulosSinFricc(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Arti_DeltaSM_AngulosSinFricc(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Arti_DeltaSM_AngulosSinFricc(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Arti_DeltaSM_AngulosSinFricc_method_dispatcher.\n"
